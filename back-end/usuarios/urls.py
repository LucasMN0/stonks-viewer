...
urlpatterns = [
    ...
    # Recuperação de senha (sua customizada)
    ...
    # JSON correto — necessário para carregar metas
    ...
    # Adicionar progresso
    path(
        'metas/progresso/<int:meta_id>/',
        views.adicionar_progresso_meta,
        name='adicionar_progresso_meta'
    ),
